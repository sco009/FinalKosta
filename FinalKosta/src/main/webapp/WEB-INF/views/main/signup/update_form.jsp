...
<link rel="stylesheet" href="/resources/bootstrap-3.3.2/css/bootstrap.min.css" type="text/css"
	media="screen" />
<link rel="stylesheet" href="/resources/dist/css/signupcss/signup.css" type="text/css"
	media="screen" />
...
<body>
	...
	<div class="row">
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" action="update_form?memberID=${vo.memberID}" class="form" method="post" name="userForm">
				<h2>Please Update Info <small>회원정보를 수정해주세요</small></h2>
				<hr class="colorgraph">
				
				<div class="form-group">
					<input type="text" name="memberID" id="memberID" class="form-control input-lg" placeholder="${vo.memberID}" tabindex="1" onkeyup="openUpdateId(this.form)"disabled="disabled">
				</div>
				
				<div class="form-group">
					<input type="password" name="memberPw" id="memberPw" class="form-control input-lg" placeholder="${vo.memberPw}" tabindex="4" value="${vo.memberPw}">
				</div>
				
				<div class="form-group">
					<input type="text" name="memberName" id="memberName" class="form-control input-lg" placeholder="${vo.memberName}" tabindex="4" value="${vo.memberName}">
				</div>
				
				
				<div class="form-group">
					<input type="text" name="memberPhoneNum" id="memberPhoneNum" class="form-control input-lg" placeholder="${vo.memberPhoneNum}" tabindex="3" value="${vo.memberPhoneNum}">
				</div>
				<div class="form-group">
					<input type="text" name="memberEmail" id="memberEmail" class="form-control input-lg" placeholder="${vo.memberEmail}" tabindex="4" value="${vo.memberEmail}">
				</div>
