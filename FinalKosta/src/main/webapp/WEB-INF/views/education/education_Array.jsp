...
<link rel="stylesheet" type="text/css" href="/resources/plugins/education/css/jquery.jscrollpane.custom.css" /><!-- 드레그 -->
<link rel="stylesheet" type="text/css" href="/resources/plugins/education/css/bookblock.css" />
<link rel="stylesheet" type="text/css" href="/resources/plugins/education/css/custom.css" /><!-- 바디관련 css -->

<script src="/resources/plugins/education/js/modernizr.custom.79639.js"></script>
<script src="http://code.jquery.com/jquery-latest.min.js"></script>
<script src="/resources/dist/js/education/eductionScript.js"></script>
<script type="text/javascript" src="/resources/bootstrap-3.3.2/js/bootstrap.min.js"></script> 
<script type="text/javascript">
$(document).ready(function() {
	var datas = "${list}";
	var slices = datas.slice(1,-1);
	var lists = slices.split(",");
...
<body id="body">
			...
			<div id="bb-bookblock" class="bb-bookblock">
				<div class="bb-item" id="item1">
					<div class="content">
						<div class="scroller">
							<h2><br><br>1. 제어문</h2>
							<form id="submit_form" action="educations" method="post">
				...
				<div class="bb-item" id="item2">
					<div class="content">
						<div class="scroller">
							...
							<form id="submit_form2" action="educations" method="post">
								<input type="hidden" name="hl_contents" class="texts">
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three1.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three2.png">
							</div>
							<p>
							...
							<br>
							<div align="center">
								<img src="/resources/dist/img/education/education_three3.png">
							</div>
							<p>
				...
				<div class="bb-item" id="item3">
					<div class="content">
						<div class="scroller">
							...
							<form id="submit_form3" action="educations" method="post">
								<input type="hidden" name="hl_contents" class="texts">
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three4.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three5.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three6.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three7.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three8.png">
							</div>
							<p>
				...
				<div class="bb-item" id="item4">
					<div class="content">
						<div class="scroller">
							...
							<form id="submit_form4" action="educations" method="post">
								<input type="hidden" name="hl_contents" class="texts">
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three9.png">
							</div>
							<p>
				...
				<div class="bb-item" id="item5">
					<div class="content">
						<div class="scroller">
							<h2><br><br>5. 배열</h2>
							<form id="submit_form5" action="educations" method="post">
								<input type="hidden" name="hl_contents" class="texts">
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three10.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three11.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three12.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three13.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three14.png">
							</div>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three15.png">
							</div>
							<br>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three16.png">
							</div>
							<br>
							<p>
							...
							<div align="center">
								<img src="/resources/dist/img/education/education_three17.png">
							</div>
							<br>
							<p>좀 더 이해를 쉽게 하기 위해서 메모리 할당할 때 “ level [①] [②] ” 차이를 그림으로 보여주겠다.<br>
							<br>int level[][];<br>①level = new int[2][];<br></p>
							<div align="center">
								<img src="/resources/dist/img/education/education_three18.png">
							</div>
							<p>②level = new int[2][3];<br>
							</p>
							<div align="center">
								<img src="/resources/dist/img/education/education_three19.png">
							</div>
						</div>
					</div>
				</div>
	...
	<script src="/resources/plugins/education/js/jquery.mousewheel.js"></script>
	<script src="/resources/plugins/education/js/jquery.jscrollpane.min.js"></script>
	<script src="/resources/plugins/education/js/jquerypp.custom.js"></script>
	<script src="/resources/plugins/education/js/jquery.bookblock.js"></script>
	<script src="/resources/plugins/education/js/page.js"></script>
	<script>
		$(function() {
			Page.init();
		});
