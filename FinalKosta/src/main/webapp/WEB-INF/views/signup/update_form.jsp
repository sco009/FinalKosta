...
<body>
	...
	<div class="row">
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" action="update_form" class="form" method="post" >
				<input name="memberID" type="hidden" value="${memberID}">
				<h2>Please Update Info <small>회원정보를 수정해주세요</small></h2>
				<hr class="colorgraph">
				
				<div class="form-group">
					<input type="text" name="memberID" id="memberID" class="form-control input-lg" placeholder="${memberID}" tabindex="1" onkeyup="openUpdateId(this.form)" disabled="disabled">
				</div>
				
				<div class="form-group">
					<input type="password" name="memberPw" id="memberPw" class="form-control input-lg" placeholder="${memberPw}" tabindex="4" value="${memberPw}">
				</div>
				
				<div class="form-group">
					<input type="text" name="memberName" id="memberName" class="form-control input-lg" placeholder="${memberName}" tabindex="4" value="${memberName}">
				</div>
				
				
				<div class="form-group">
					<input type="text" name="memberPhoneNum" id="memberPhoneNum" class="form-control input-lg" placeholder="${memberPhoneNum}" tabindex="3" value="${memberPhoneNum}">
				</div>
				<div class="form-group">
					<input type="text" name="memberEmail" id="memberEmail" class="form-control input-lg" placeholder="${memberEmail}" tabindex="4" value="${memberEmail}">
				</div>
