	...
	<div class="row-fluid">
		<div class="col-md-12">
			<div class="row-fluid side">
				<label id="toplabel"><b>카테고리:</b>
					${multipleSelect.mulquestCategori }</label> <label id="toplabel"><b>난이도
						:</b>${multipleSelect.mulquestLevel }</label>
			</div>
			...
			<div class="col-md-4 checkd side">
				...
				<div id="solveButton" style="display: none">
					...
					<c:if test="${signal==1}">
						<input type="hidden" name="solveSelectId"
							value=${multipleSelect.mulquestId }></input>
						<input type="button" name=" finishButton" value="결과보기"
							class="multipleSelect_css" onclick=Next()></input>
					</c:if>
