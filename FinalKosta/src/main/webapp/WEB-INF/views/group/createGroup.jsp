   ...
   $(document).ready(function(){
      ...
      function successHandler(data) {//검색하고나서 검색된애들 체크박스로 리스트 뿌려주기
         ...
         $.each(data,function(index, entry){
            html = '<div class="col-md-3"><label class="btn btn-info">'
                  ...
                  + '<h3 id="h1name">'+ entry.memberName+ '</h3></label></div>';
         ...
         $.each(data,function(index, entry){
            html =  '<div class="my-box">'+
                  '<div class="checkbox-inline pull-left">'+
                     '<label> <input type="checkbox" value="'+entry.memberID+'" name="check">'+entry.memberName+'</label></div>'+
   ...
   function list(data){
         ...
         for(var j=0; j<3; j++){
            for(var k=0; k<3; k++){
               if( data.length != count )
                  html = '<a class="h3 align-center" href="goGroupMain?groupID='+data[count].groupID+'">'+
                  '<div class="tr"></div>'+
                  '<div class="tl"></div>'+
                  '<div class="br"></div>'+
      ...
      $outterDiv.each(function(index){
         ...
         for(var i = 0 ; i < amount[index] ; i++){
            var $dataDiv = $('<div/>',{class:'well'}).appendTo($(this));
...
<body>
   <div class="container">
   <header>
         <button class="btn btn-default btn-lg" data-toggle="modal" data-target="#myModal">그룹 생성</button>
    </header>
    <section>
               ...
               <div class="modal-body">
                  ...
                  <div class="row">
                     <form id= 'searchedListForm' method="get">
                        ...
                        <div class="Addmember" align="right">
                  ...
                  <label class="h3">초대 메시지</label>
                  <TEXTAREA class="form-control container-fluid" ROWS="5"NAME="TextArea1" id ="TA1">
                  </TEXTAREA>
                  ...
                  <button type="button" class="btn btn-info" onClick="invite()">완료</button>
