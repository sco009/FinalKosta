...
<form role="form" method="post">
	...
	<input type='hidden' name='bno' value="${CTBoardVO.bno}">
...
<div class="box-body">
	...
	<div class="form-group">
		...
		<textarea class="form-control" name="content" rows="3"
			readonly="readonly">${CTBoardVO.content}</textarea>
	</div>
	<div class="form-group">
...
$(document).ready(function(){
	...
	$(".btn-warning").on("click", function(){
		formObj.attr("action", "/codetrace/modify");
		formObj.attr("method", "get");		
		formObj.submit();
	});
	
	$(".btn-danger").on("click", function(){
		formObj.attr("action", "/codetrace/remove");
		formObj.submit();
	});
