...
import cosmos.codetrace.service.ReplyService;

@RestController
@RequestMapping("/codetrace/replies")
public class ReplyController {
	...
	public ResponseEntity<Map<String, Object>> r_listPage(@PathVariable("bno") Integer bno,
